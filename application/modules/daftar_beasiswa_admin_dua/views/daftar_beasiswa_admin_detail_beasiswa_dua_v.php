            ...
            <?= $this->session->flashdata('pesan'); ?>
                      ...
                      <div class="col-sm-12 col-md-7 col-lg-7">
                          <div class="invoice card author-box card-warning">
                            ...
                            <div class="text-md-right">
                                    <a href="<?= base_url('daftar-beasiswa-admin-dua'); ?>" class="btn btn-danger btn-icon icon-left"><i class="fas fa-times"></i>Kembali</a>
                            </div>
                          </div>
                      </div>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-12 col-md-12 col-sm-12">              
                      <div class="card card-warning">
                          <div class="card-header">
                              <h4 style="font-size: 20px; color: #34395e;">List mahasiswa yang sudah didaftarkan oleh admin bersangkutan</h4>
              ...
              <div class="modal fade" id="checkNim" tabindex="-1" role="dialog" aria-labelledby="checkNimLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <?= form_open_multipart('daftar-beasiswa-admin-dua/detail/'.$detail_beasiswa['id']) ?>
    ...
    <!--  -->
         ...
         <script>
          ...
          $('#data_pendaftar_beasiswa').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('daftar-beasiswa-admin-dua/get_ajax/'.$detail_beasiswa['id'].'/half') ?>",
                "type": "POST"
            },
