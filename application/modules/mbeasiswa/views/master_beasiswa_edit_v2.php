                            ...
                            <div class="col-6 col-md-6 col-lg-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" name='tgl_tutup_pendaftaran' value="<?php echo date("Y-m-d\TH:i", strtotime($master_beasiswa->tgl_tutup_pendaftaran)); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" name='tgl_awal_penetapan' value="<?php echo date("Y-m-d\TH:i", strtotime($master_beasiswa->tgl_awal_penetapan)); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" name='tgl_tutup_penetapan' value="<?php echo date("Y-m-d\TH:i", strtotime($master_beasiswa->tgl_tutup_penetapan)); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" name='tanggal_penetapan' value="<?php echo date("Y-m-d\TH:i", strtotime($master_beasiswa->tanggal_penetapan)); ?>">
