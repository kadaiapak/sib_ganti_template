...
class Validasi_m extends CI_Model
{
    ...
    public $column_order = array(null, 'mahasiswa_beasiswa.nim_mahasiswa',
    ...
    public $column_search = array('mahasiswa_beasiswa.nim_mahasiswa', 'mahasiswa_beasiswa.nama_mahasiswa'); //set column field database for datatable searchable
